...
```jsonc
{
  ...
  "situation_text": "Ich bin Schreiner-Lernende/r im 1. Lehrjahr...",  // DOC-S: main body (5-6 sentences), 1. Ps. Sg. (Ich)
  "zahlen_tabelle": [                          // DOC-S: data table below situation text (optional)
    { "label": "Wochenlohn", "wert": "CHF 600" }
  ],
  "leitfrage": "Darf mein Berufsbildner/in das?", // DOC-S: callout box "LEITFRAGE" (singular), Ich-Perspektive
  "mehrdeutigkeit": {
    "explizit": true,
  ...
  "leitfragen_intro": "Bearbeiten Sie die Leitfragen einzeln...",  // DOC-S: intro text before LF list (Sie-Form)
  "leitfragen": [                              // FIXED: exactly 4 items
    {
      "nr": 1,                                 // DOC-S: "LF1" prefix (Consolas bold, accent)
      "text": "Nennen Sie die fünf wichtigsten Punkte...",  // DOC-S: question text (Sie-Form)
...
| 4 | Austausch & Transfer | `set.austausch_phase`, `set.dekontextualisierungs_aufgabe`, `sit.dekontextualisierung.frage` | Full text | Full text + "Ihr Transfer" writing field |
...
```jsonc
{
  ...
  "dekontextualisierungs_aufgabe": {
    "auftrag": "Übertragen Sie das Kernprinzip aus Ihren drei Herausforderungen auf einen neuen, selbst gewählten Kontext.",
  ...
  "kn_typen": [
    ...
    // ── Typ 1: Fachgespräch ─────────────────────────────────────────────────
    {
      ...
      "fragestruktur": [                  // FIXED: 5 items, K2→K3→K3→K4→K4
        { "nr": 1, "frage": "Erklären Sie mit eigenen Worten...", "typ": "Erklären",   "k_stufe": 2 },
        { "nr": 2, "frage": "Wenden Sie die Kanal-Logik an...",   "typ": "Anwenden",  "k_stufe": 3 },
        { "nr": 3, "frage": "Sie müssen Ihr Recht einfordern...", "typ": "Beurteilen", "k_stufe": 3 },
        { "nr": 4, "frage": "Vergleichen Sie diesen Vorfall mit...", "typ": "Transfer", "k_stufe": 4 },

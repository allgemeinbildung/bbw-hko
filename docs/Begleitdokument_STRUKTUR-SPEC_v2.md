...
stand: "2026-06-22"
status: "v2 — distilliert aus 2 Referenzdokumenten + 5 LP-Support-Erweiterungen (TEIL 6)"
quellgrundlage:
...
| — | **Anhang — Quellen** | ✓ | JSON-Quellen + didaktische Grundlagen mit Quick-Ref-§-Verweisen |
...
**Ende Spezifikation v2.**

Offen für Pietro: die drei Klärungspunkte aus **TEIL 4** (Stufenskala 0–3 vs. 1–4, Zielanspruchs-Band 80 vs. 90 %, „unter 60 %"-Band) bleiben unverändert offen — sie betreffen Skalen/Bänder und sind unabhängig von den v2-Erweiterungen. Nächster Schritt nach dieser Klärung: Einarbeitung der gesamten Spec (TEIL 1–7) in den `hko-einheits-begleiter` Skill als Template-Contract.

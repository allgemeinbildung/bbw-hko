...
begin
  ...
  insert into public.materials (
    ...
    ARRAY['Recht', 'Identität & Sozialisation'],
  ...
  insert into public.materials (
    ...
    'Abt. 1',
    ARRAY['Technologie und digitale Transformation', 'Werthaltungen reflektieren', 'Quellen unterscheiden'],
    ARRAY['Technologie und digitale Transformation', 'Identität & Sozialisation'],
  ...
  insert into public.materials (
    ...
    ARRAY['Identität & Sozialisation', 'Ethik'],
    'Produktion mündlich',
    ARRAY[]::text[],
  ...
  insert into public.materials (
    ...
    ARRAY['Politik', 'Technologie und digitale Transformation'],
  ...
  insert into public.materials (
    ...
    ARRAY['Ökologie', 'Ethik', 'Wirtschaft', 'Identität & Sozialisation'],
    'Rezeption audiovisuell',
  ...
  insert into public.materials (
    ...
    ARRAY['Identität & Sozialisation', 'Technologie und digitale Transformation'],

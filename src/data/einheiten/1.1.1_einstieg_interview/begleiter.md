---
titel: "Begleit-Dokument — Wie ich frage, so erfahre ich (1.1.1)"
...
lebensbezug: "1.1"
quellen_json:
  - "1.1.1_einstieg_interview_set.json"
...
# Begleit-Dokument — Wie ich frage, so erfahre ich (1.1.1)

> Dieses Dokument richtet sich an die **Lehrperson**, nicht an die Lernenden. Hier steht, **wie** Sie die Einheit führen: Aufbau, Durchführungsvarianten, Wochenablauf, Austausch-Phase, Bewertung.

---

## 0. Diese Einheit ist anders gebaut
...
**Schlüsselkompetenzen.** Verwendet werden ausschliesslich SK mit R1 in T1: SK2 (Ziele setzen und anpassen), SK4 (In Teams arbeiten), SK6 (Standpunkte begründen), SK8 (Lebensphasen planen).
...
> Jede Lernende führt **und** wird befragt. Wer selbst einsilbig geantwortet hat, versteht in L3 besser, warum die eigene Methode beim Gegenüber so gewirkt hat, wie sie gewirkt hat. Planen Sie in L2 je 15 Minuten pro Richtung plus 5 Minuten Wechsel.

### Coaching-Bewegungen in L2
...
> [!mehrdeutigkeit] Der Zielpunkt — und wo es kippt
> Das Ziel ist **nicht** «jede Methode hat Vor- und Nachteile». Das ist die bequeme Antwort, und die Klasse wird sie Ihnen anbieten. Bohren Sie weiter: Warum bringt dieselbe Aufgabe bei derselben Klasse so verschiedene Profile hervor? Der Zielpunkt ist die Einsicht, dass **das Ergebnis von der Methode mitproduziert** wird — und dass die befragende Person damit Mitverantwortung für das entstandene Bild trägt.
...
**Drei KN-Typen** stehen zur Wahl: Fachgespräch (25–30 Min.), Mini Case schriftlich (45 Min.), Werkschau mit Transfer-Reflexion (10 Min.). Alle drei greifen auf dasselbe Raster zu.

**Bewertung bi-dimensional**, SuK und Ges gleichgewichtet:

| Dimension | Kriterium |
|---|---|
| SuK | Fachkorrektheit (Fragearten, Gesprächsbegriffe) |
| SuK | Begründung der Methodenwahl |
| Ges | Methode als Erkenntnisrahmen |
| Ges | Rolle und Rücksichtnahme |

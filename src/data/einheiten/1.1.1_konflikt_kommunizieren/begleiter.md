---
titel: "Begleit-Dokument — Konflikte kennen, kommunizieren, klären (1.1.1)"
...
lebensbezug: "1.1"
quellen_json:
  - "1.1.1_konflikt_kommunizieren_set.json"
  - "1.1.1_konflikt_kommunizieren_prinzip.json"
  - "1.1.1_konflikt_kommunizieren_sit_A.json"
  - "1.1.1_konflikt_kommunizieren_sit_B.json"
  - "1.1.1_konflikt_kommunizieren_sit_C.json"
  - "1.1.1_konflikt_kommunizieren_kn.json"
---

# Begleit-Dokument — Konflikte kennen, kommunizieren, klären (1.1.1)
...
> „Ich erkenne meine Rechte im Konflikt, wähle Kanal und Ton adressatengerecht und führe ein Konfliktgespräch so, dass die Beziehung trägt."

Dieser eine Satz ist der Massstab. Alles in der Einheit zahlt darauf ein: A = Rechte erkennen, B = Kanal/Ton wählen, C = Gespräch führen.
...
|---|---|
| Rechte/Pflichten Lehrvertrag (OR 321a, 345, 345a; ArG 31) | Argumentieren nach 3B-Schema (Behauptung-Begründung-Beispiel) |
| Konfliktfallregelung (Selbstkritik → Gespräch → BBV → ABB) | Geschäftsbrief/E-Mail: Anlass-Absicht-Begründung-Schluss, Register |
| Kommunikationsquadrat Schulz von Thun (Vier Ohren) | Stellungnahme / Positionspapier verfassen |
| Ich-Botschaft vs. Du-Botschaft | adressatengerechte Sprache, Kanalbegründung |
| ethische Prüfung (Würde, Macht, Norm — Kap. 18.2) | Gesprächsführung: Ich-Botschaft, aktives Zuhören, Win-Win |
| Medienkompetenz (privat vs. geschäftlich trennen — Kap. 20.7) | Drehbuch dialogisch strukturieren |

### Verbindungsformel — so hängen GES und SuK zusammen

> Die Lernende **verfasst eine begründete Position / wählt einen Kanal / führt ein Gespräch** *(SuK-Sprachhandlung)*, indem sie **ihre Rechte aus dem Lehrvertrag / die Medien- und Ethikkriterien / das Vier-Ohren-Modell** *(GES-Wissen)* nutzt, um **im Konflikt handlungsfähig zu bleiben, ohne die Lernbeziehung zu zerstören** *(Handlungsziel)*.
...
| Iteration | Verortung |
|---|---|
| **R1 (jetzt)** | T1 — Konflikt im Lehrverhältnis, Grundlagen klären |
| R2 (Voraussicht) | T4 — Verantwortung im sozialen und gesundheitlichen Zusammenleben |
| R3 (Voraussicht) | T7 — Konflikte in der Arbeitswelt nach der Lehre (MA-Gespräch, Kündigung, Mobbing) |
...
| Kap. | Titel | Seiten |
|---|---|---|
| 1.4 | Der Lehrvertrag — Rechte/Pflichten, Konfliktfallregelung, Aussprache | 28-37 |
| 17.1 | Dokumentieren — Notiztechniken, Markieren mit Symbolen | 372-378 |
| 17.2 | Argumentieren — Stellungnahme, 3B-Schema | 384-392 |
| 17.3 | Korrespondenz — Geschäftsbrief und E-Mail | 396-404 |
| 18.1 | Identität — Rollenübernahme, Selbstwert | 408-412 |
| 18.2 | Werte, Normen, Moral und Ethik — Zwickmühlen | 416-420 |
| 19.1 | Feedback — geben und annehmen | 422-423 |
...
> Sie sind Schreiner-Lernende/r im 1. Lehrjahr. Ihr Berufsbildner/in überträgt Ihnen an einem Samstag die alleinige Inventur plus eine berufsfremde Werkstatt-Grundreinigung; zweimal in dieser Woche wurde die 9-Stunden-Grenze für Jugendliche überschritten. Sie fühlen sich verpflichtet, ja zu sagen, und gleichzeitig unsicher: Darf er das überhaupt?

> [!hinweis] Qualität der Situation (8 Merkmale Lernsituation)
> Authentizität, Verortung (Winterthur, konkrete Zahlen), Problem (kein Reproduktionsauftrag), Affektivität (Verunsicherung), Kognition (K2-K4), Aktivität (Positionspapier), LJ-Passung (1. LJ, Lehrvertrag ist das erste echte Rechtsdokument), Relevanz (jede/r hat einen Lehrvertrag) — alle acht erfüllt. Die Zahlen-Tabelle gibt Ihnen den Realismus-Anker fürs Plenum.
...
> Lernende nennen oft nur den **einen** offensichtlichen Punkt (Reinigung = berufsfremd) und übersehen die **Arbeitszeit** (2× über 9 h). Fragen Sie gezielt nach der Zahlen-Tabelle: „Schauen Sie nochmal auf die Stunden — ist da auch etwas?" Beide Punkte sind die Bewertungsgrundlage fürs Positionspapier.

**LF3 (K3):** Konfliktweg wählen — direktes Gespräch / BBV / kantonales Amt.
...
|---|---|---|---|
| *Bsp:* Werkstatt-Grundreinigung am Samstag verlangt | Recht auf nur berufsbezogene Arbeiten (OR 345a, BiVo) | Reinigung gehört nicht zu meiner Ausbildung | „Muss halt auch gemacht werden, gehört zum Betrieb" |
...
Ich bin der Ansicht, dass __________________________________ nicht mit
meinem Lehrvertrag vereinbar ist.

BEGRÜNDUNG (2-3 Sätze, mind. 1 Artikel):
Laut ____________ (OR/ArG-Artikel) habe ich das Recht / die Pflicht,
__________________________. Das wichtigste Argument zuletzt: ___________
________________________________________________________________________.

BEISPIEL (konkret aus meiner Woche):
Konkret zeigte sich das, als _____________________________________________.

SCHLUSS (als Wunsch, nicht als Drohung):
Mir ist wichtig, dass _________________________; deshalb wünsche ich mir
________________________________________________________________________.
```
...
| Wissensknoten | geschäftsbrief_email_register |

> Sie sind Automobilfachmann-Lernende/r im 2. Lehrjahr. Ihr Berufsbildner/in hat Sie gestern vor Kunden und Mechanikern lautstark kritisiert; heute schickt er Ihnen eine knappe WhatsApp an die **private** Nummer mit Ultimatum bis 18 Uhr. Sie wollen zurückmelden — aber WhatsApp privat, Geschäftsmail oder Brief? Und in welchem Ton?
...
**LF1 (K2):** Aufbau Geschäftsbrief (Anlass-Absicht-Begründung-Schluss) + E-Mail-Regeln.
...
|---|---|---|---|
| Schnelligkeit | sofort | Stunden | Tage |
| Verbindlichkeit / Beweismittel | gering, informell | mittel, dokumentiert | hoch, formell |
...
BEGRÜNDUNG (Ihre Sicht, sachlich) __________________________________
          ___________________________________________________________
SCHLUSS   (Konkreter Lösungsvorschlag) _____________________________
...
| Wissensknoten | konfliktgespräch_ich_botschaften |

> Sie sind Informatik-Lernende/r im 1. Lehrjahr. Ein neuer Berufsbildner/in gibt kaum Feedback, kritisiert Sie aber im Sprint-Review vor dem Team mit „Du hörst einfach nicht zu." Sie fühlen sich abgestempelt. Heute bietet er Ihnen 15 Minuten für eine Aussprache an — Sie wollen hin, aber nicht in eine zweite Demütigung laufen.
...
**LF1 (K2):** Vier Ebenen Schulz von Thun — den Satz „Du hörst einfach nicht zu" decodieren.
...
> [!warnung] Typischer Stolperstein bei LF2
> Pseudo-Ich-Botschaften: „Ich finde, dass **du** nie zuhörst" ist eine getarnte Du-Botschaft. Echte Ich-Botschaft = eigenes Empfinden + konkretes Verhalten + Wunsch, **ohne Etikett**. Sammeln Sie zwei, drei Pseudo-Versionen aus der Klasse und reparieren Sie sie gemeinsam.
...
|---|---|---|---|---|
| *„Du hörst einfach nicht zu."* | Du verstehst die Aufgabe nicht | Ich bin frustriert / unter Druck | Ich nehme dich nicht ernst | Streng dich mehr an |
| (eigene Schlüsselaussage 1) | | | | |
| (eigene Schlüsselaussage 2) | | | | |

**Ich-Botschaft-Satzanfänge (Liste zum Aushängen):**

```
„Ich empfinde es als ..., wenn ..."
„Mir ist wichtig, dass ..."
„Ich brauche etwas mehr Zeit, um ..., das heisst aber nicht, dass ..."
„Ich wünsche mir, dass wir ..."
(Regel: eigenes Empfinden + konkretes Verhalten + Wunsch — kein Etikett.)
```

**Drehbuch 3-Spalten-Template (Beispielzeile ausgefüllt):**

| Ich sage | Ich höre | Ich frage |
|---|---|---|
...
> Wer im Konflikt handlungsfähig ist, klärt zuerst die Sachlage und die eigenen Rechte, wählt dann bewusst den Kommunikationskanal und das Register, und führt das Gespräch so, dass beide Seiten ihr Gesicht wahren.

> [!lernziel] So sieht guter Transfer aus
> Ein starker Transfer nimmt das **Prinzip** (klären → Kanal wählen → Gesicht wahren) und zeigt es in einem **fremden** Feld — z. B.: „Als mein Vermieter eine Nebenkosten-Nachzahlung verlangte, habe ich zuerst den Mietvertrag und das OR geprüft (Sachlage/Rechte), dann bewusst einen schriftlichen Brief statt einer WhatsApp gewählt (Kanal/Verbindlichkeit), und so formuliert, dass eine weitere Zusammenarbeit möglich bleibt (Gesicht wahren)." — drei Schritte erkennbar, Lehrmittelbegriffe drin, neuer Kontext.

> [!warnung] Typischer Stolperstein
> Schwache Transfers **wiederholen** nur den Lehrbetriebs-Fall mit anderen Namen. Wenn jemand wieder über den Berufsbildner/in schreibt, ist das kein Transfer. Verlange einen Kontext **ausserhalb** des Lehrbetriebs (Familie, Verein, WG, Vermieter).
...
|---|---|
| **A — Rechtsklärung** | Bitte, die Lerndoku **nicht** zu führen („vertraulich") kollidiert mit Lerndoku-Pflicht und Treuepflicht |
| **B — Kanalwahl** | private WhatsApp mit Ultimatum zwingt zur Entscheidung: informeller Kanal oder verbindlicher, geschäftlicher Kanal? |
...
|---|---|---|---|---|
| **Fachgespräch** | mündlich, 30-35' (15' Vorbereitung + 15-20' Gespräch), 5 Fragen K2→K4 | mündliche Argumentation, Werthaltung | Rez schriftl. + Prod mündl. + Int mündl. | du **mündliche** Kompetenz und Werthaltung sehen willst; kleine Gruppe; Zeit pro Lernende/r vorhanden |
